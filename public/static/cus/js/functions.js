...
function replaceContent(content) {
    ...
    content = (content || '').replace(/&(?!#?[a-zA-Z0-9]+;)/g, '&amp;')
        ...
        .replace(/file\([\s\S]+?\)\[[\s\S]*?\]/g, function (str) { // 转义文件
            ...
            if (!href) return str;
            return '<a class="layui-whisper-file" href="../../public/uploads/' + href + '" download target="_blank"><i class="layui-icon">&#xe61e;</i><cite>' + (text || href) + '</cite></a>';
        })
...
var faces = function () {
    ...
    layui.each(alt, function (index, item) {
        arr[item] = '../../../public/static/cus/js/layui/images/face/' + index + '.gif';
    });
    return arr;
}();
