...
class Playday extends Model
{

    protected $table = "oyo_play_day";
    ...
    {
        try {
            $result = $this->validate('PlaydayValidate')->save($param);
    ...
    {
        try {
            $result = $this->validate('PlaydayValidate')->save($param, ['id' => $param['id']]);
